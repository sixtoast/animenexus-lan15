  ...
  return (
    <>
      ...
      <div
        className={
          "mascot-dock" +
          (modalOpen ? " mascot-dock--soft" : "") +
          (dockOpen ? " mascot-dock--open" : " mascot-dock--collapsed")
        }
        role="region"
      ...
      >
        <button
          type="button"
          className="mascot-dock-handle"
          aria-expanded={dockOpen}
          aria-controls="mascot-dock-panel"
          aria-label={
            dockOpen
              ? "Collapse Lantern-ko controls"
              : "Open Lantern-ko controls"
          }
          onClick={() => setDockOpen((v) => !v)}
        >
          <span className="mascot-dock-handle-dot" aria-hidden />
          <span className="mascot-dock-handle-label">Lantern-ko</span>
        </button>
        <div
          id="mascot-dock-panel"
          className="mascot-dock-panel"
          hidden={!dockOpen}
        >
          ...
          <button
            ...
            aria-label="Toggle companion sound"
          ...
          <button
            ...
            aria-label="Toggle companion interactions"
            aria-pressed={interactOn}
          >
            {interactOn ? "Interactive" : "Passive"}
          </button>
          <button
            type="button"
            className="mascot-hide"
