...
import { browseParamsFromQuery } from "@/lib/browse-intent-apply";
...
export function BrowseClient({
  ...
  const applyFilters = () => {
    ...
    const patch = browseParamsFromQuery(query, {
      genre,
      status,
      format,
      year,
    ...
    if (patch.format) setFormat(patch.format);
    ...
    if (patch.genre)
      emitNexus({ type: "filter_used", filter: `genre:${patch.genre}` });
  };
  ...
  return (
    <div className="browse-desk">
      ...
      >
        ...
        <details className="discover-refine">
          <summary>Refine · database filters</summary>
