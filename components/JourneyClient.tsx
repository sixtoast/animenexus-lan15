      ...
      <section className="journey-section">
        ...
        {insights.length === 0 ? (
          <SignalEmpty
            ...
            body="Seal and finish a few titles to give Lantern evidence. Insights stay on this device."
          ...
          <section className="journey-section">
            ...
            {events.length === 0 ? (
              <SignalEmpty
                ...
                body="Browse, seal, and complete titles — meaningful moments fill this path."
                action={{ label: "Browse catalog →", href: "/browse" }}
