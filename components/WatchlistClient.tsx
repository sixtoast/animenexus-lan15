...
import { ArchiveField } from "@/components/archive-field/ArchiveField";
import {
  WatchlistShelfEmpty,
  WatchlistTabEmpty,
  ...
  if (!ready) {
    return (
      <div className="state-box">
        ...
        <p style={{ marginTop: 12 }}>Lantern is opening your archive…</p>
      </div>
    );
  }
      ...
      >
        ...
        {presentation === "shelf" ? (
          <p className="tools-hint" style={{ margin: 0 }}>
            Archive Field — every sealed title as a node. Orbit, constellation, or timeline.
          </p>
        ) : null}
      </div>

      {presentation === "shelf" ? <ArchiveField entries={entries} /> : null}
